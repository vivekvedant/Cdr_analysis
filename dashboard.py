...
def update_app_ui(Tabs, start_date, end_date, group, report_type,device_date,service_date):
    ...
    if Tabs == "tab-1":
        ...
        card_2 = create_card("Incoming Calls", incoming_calls, "secondary")
        ...
        graphRow0 = dbc.Row([dbc.Col(id='card1', children=[card_1], md=3), dbc.Col(id='card2', children=[card_2], md=3),dbc.Col(id='card3', children=[card_3], md=3)])
        graphRow1 = dbc.Row([ dbc.Col(id='card4', children=[card_4], md=3),dbc.Col(id='card5', children=[card_5], md=3), dbc.Col(id='card6', children=[card_6], md=3)])
        
        cardDiv = html.Div([graphRow0,html.Br(), graphRow1,html.Br()],style = {'margin-left': '10%','margin-right': '-20%'})
